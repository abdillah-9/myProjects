...
$_SESSION['user_password'] = $_POST['passwords'];
  ...
  if($valid == true){
     $selected2 = "SELECT id FROM users WHERE username ='$usernames' AND
     passwords ='$passwords'";
     $checkSelection2 = mysqli_query($conn,$selected2);

     if(mysqli_num_rows($checkSelection2) > 0){
      $u_id2 = mysqli_fetch_array($checkSelection2);
      $get_id2 = $u_id2['id'];
      $_SESSION["get_id"] = $get_id2;
               //redirect user
               if($usernames == "Admin"){
...
@media screen and (min-width:650px){
    ...
    <body>
      ...
      <div>
            ...
            <a href="Sign-Up.php">Click Here</a><br>
